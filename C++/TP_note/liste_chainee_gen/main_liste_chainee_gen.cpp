// liste_chainee_gen.cpp : Ce fichier contient la fonction 'main'. L'exécution du programme commence et se termine à cet endroit.
//

#include "liste_chainee_gen.h"
#include "fraction.h"

int main()
{
	//déclaration des variables
	int choix_menu = 1, index_elt, choix_liste1 = -1, choix_liste2 = -1, choix_liste_add = -1;
	Fraction frac;
	liste_chainee<Fraction> tab_liste[11] = { liste_chainee<Fraction>() };
	bool continuer = true;
	...
	try {
		...
		while (continuer) {
			...
			case 2:
				...
				//méthode push_front
			case 3:
				cout << "Saisir fraction : ";
				cin >> frac;
				tab_liste[choix_liste1 - 1].push_front(frac);
				break;
			...
			case 4:
				cout << "Saisir fraction : ";
				cin >> frac;
				tab_liste[choix_liste1 - 1].push_back(frac);
				break;
			...
			case 7:
				...
				cout << "Saisir index : ";
				cin >> index_elt;
				tab_liste[choix_liste1 - 1].insert(index_elt, frac);
				break;
			...
			case 12:
				cout << "Saisir fraction : ";
				cin >> frac;
				tab_liste[choix_liste1 - 1].remove(frac);
				break;
